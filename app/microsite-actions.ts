...
function mergeUploadedAssetsIntoLibrary(
  ...
  const entries = [
    ...
    assetLibraryEntry(urls.deals_illustration, "Vorteile Intro Upload", "deals.illustrationUrl", now),
    assetLibraryEntry(urls.top_deal, "Vorteilsbild Upload", "deals.topDealImageUrl", now),
    ...
    assetLibraryEntry(urls.reward_5_image, "5er-Belohnung Upload", "stamps.reward.5.image", now),
    assetLibraryEntry(urls.reward_10_image, "10er-Belohnung Upload", "stamps.reward.10.image", now),
