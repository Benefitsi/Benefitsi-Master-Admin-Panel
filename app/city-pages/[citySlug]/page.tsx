        ...
        >
          ...
          <div className="grid gap-5 p-5 sm:p-6">
            <div className="grid gap-4 md:grid-cols-2">
              <Field label="Stadtname" required>
                <input
                  name="name"
                  required
                  maxLength={180}
            ...
            <Field label="Einleitung" required helper="Klare lokale Zusammenfassung für Bewohner, Besucher und Suchmaschinen.">
              <textarea
                name="intro"
                required
                maxLength={4000}
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <Field label="Hero-Bild URL" helper="Nur HTTPS/HTTP. Das Bild sollte mindestens 1600 px breit sein.">
                <input
                  name="heroImageUrl"
                  type="url"
                  maxLength={2000}
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <Field label="SEO-Titel" helper={`${city.seoTitle.length}/180 Zeichen`}>
                <input
                  name="seoTitle"
                  maxLength={180}
              ...
              <Field label="SEO-Beschreibung" helper={`${city.seoDescription.length}/500 Zeichen`}>
                <textarea
                  name="seoDescription"
                  maxLength={500}
                  rows={3}
