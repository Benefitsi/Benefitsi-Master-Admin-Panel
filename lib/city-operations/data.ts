...
const contentDefinitions: ContentDefinition[] = [
  {
    ...
    select:
      "id,city_id,title,description,category,status,source_name,source_url,start_date,end_date,expires_at,last_verified_at,updated_at",
  },
  {
    contentType: "places",
    table: "city_places",
  ...
  },
  {
    ...
    descriptionField: "description",
    select:
      "id,city_id,title,description,category,status,source_url,expires_at,last_verified_at,updated_at",
  },
  {
